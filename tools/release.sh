...
mkdir -p "$STAGE"
cp -a LICENSE NOTICE README.md CHANGELOG.md RELEASE_READINESS.md SECURITY.md include dist src cli examples spec tools CMakeLists.txt Makefile meson.build "$STAGE"/
